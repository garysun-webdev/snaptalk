/*
 ...
 Author: CoDex
 Purpose: This is the main function file of photo and movie capture, which contains six functions to get the image data.
 */
...
class PhotoCaptureDelegate: NSObject, AVCapturePhotoCaptureDelegate {
    ...
    //Use FileManager to manage taken image data
